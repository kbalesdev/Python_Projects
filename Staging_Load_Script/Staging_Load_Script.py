...
#%%
# Connect to database
engine_params = urllib.parse.quote_plus("DRIVER=ODBC+Driver+17+for+SQL+Server;SERVER={0};DATABASE={1};Trusted_Connection=yes;".format(server_name, database))
...
df.to_sql(f"{target_insert_table_name}", engine, index=False, if_exists="replace", schema="dbo")
